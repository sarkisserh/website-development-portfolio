            ...
            <div class="tab-content">
                <?php foreach ($languages as $language) { ?>
                    ...
                    <textarea rows="6"
                          name="<?php echo $this->nameSpace . $property; ?>[<?php echo $language['language_id']; ?>]"
                          id="<?php echo $this->nameSpace . $property . $language['language_id']; ?>"
                          class="form-control"><?php echo isset($this->params[$this->nameSpace . $property][$language['language_id']]) ? $this->params[$this->nameSpace . $property][$language['language_id']] : ''; ?></textarea>
                    </div>
                <?php } ?>
            </div>
            </div>
