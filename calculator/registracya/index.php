...
$APPLICATION->SetPageProperty("title", "Список тарифов РКО банков с услугой  бесплатной регистрации ИП");
$APPLICATION->SetPageProperty("description", "Список тарифов банков, где вы можете зарегистрировать ИП бесплатно. Типы регистрации (без визита в ФНС либо самостоятельная подача)");
...
?><? $APPLICATION->IncludeComponent(
    ...
    <div id="content-bank-ajax">
        ...
        $GLOBALS['arFilter'] = ['ID' => getTariffIdListByGeoFilter($step)];
        ?>
        <?$APPLICATION->IncludeComponent(
	"bitrix:news.list", 
	"tariff-list_registracya", 
	array(
		...
		"COMPONENT_TEMPLATE" => "tariff-list_registracya",
		"SORT_BANKS" => array(
			0 => "Сбербанк",
			1 => "Альфа Банк",
			2 => "ВТБ",
